...
- **Safety model / threat model**: brief update from [@CarlosAndresRamirez](https://discourse.llvm.org/u/carlosandresramirez) on its status.

**Note:**
Since no one else joined today’s Americas-friendly LLVM Qualification Group sync-up, I cancelled the call (after 10min).
We’ll keep the June topics for the next sync-up (next Tuesday).
Thanks!
